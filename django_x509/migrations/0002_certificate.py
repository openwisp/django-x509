...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='ca',
            name='private_key',
            field=models.TextField(blank=True, help_text='private key in X.509 PEM format'),
        ),
        migrations.AlterField(
            model_name='cert',
            name='digest',
        ...
        migrations.AlterField(
            model_name='ca',
            name='certificate',
            field=models.TextField(blank=True, help_text='certificate in X.509 PEM format'),
        ),
        migrations.AlterField(
            model_name='cert',
            name='certificate',
